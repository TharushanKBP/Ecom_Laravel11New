                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="my-account__address-list">
                                <div class="my-account_address-list_detail">
                                    <p>{{$address->name}}</p>
                                    <p>{{$address->address}}</p>
                            ...
                            <table class="cart-totals">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">-${{ Session::get('discount')['discount'] ?? 0 }}</td>
                                    </tr>
                                    @endif
                                    <tr>
                                        <th>Shipping</th>
                                    ...
                                    <tr>
                                        <th>Total</th>
                                        <td class="text-right">${{ Session::has('discount') ? Session::get('discount')['total'] : Cart::instance('cart')->total() }}</td>
                                    </tr>
                                </tbody>
                            </table>
                            @else
