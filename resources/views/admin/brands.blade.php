            ...
            <div class="flex items-center justify-between gap10 flex-wrap">
                <div class="wg-filter flex-grow">
                    <form class="form-search" method="GET" action="{{ route('admin.brands') }}">
                        <fieldset class="name">
                            <input type="text" placeholder="Search here..." class="" name="name" value="{{ request('name') }}" tabindex="2" aria-required="true" required="">
                        </fieldset>
                ...
                <a class="tf-button style-1 w208" href="{{ route('admin.brands') }}"><i class="icon-plus"></i>Add new</a>
            </div>
